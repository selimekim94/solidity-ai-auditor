...
Website: https://www.dappai.io
Twitter: https://www.dappai.io
Gitbook: https://dapp-ai-1.gitbook.io/dapp-ai-product-docs/token-metrics
*/
...
contract dAppAI is Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, address claimTokenWallet, address _deployer) {
        _name = name_;
        _symbol = symbol_;
